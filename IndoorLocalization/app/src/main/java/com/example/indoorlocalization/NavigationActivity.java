...
public class NavigationActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        remained_distance.setText("남은 거리 : " + String.valueOf(dist));
        String sentence = "출발지 : " + start_point + "\n목적지 : " + dest_point;
        address_point.setText(sentence);

        /* Rotate image view(user direction) */
        // sample
        onDirectionRotate(30);
